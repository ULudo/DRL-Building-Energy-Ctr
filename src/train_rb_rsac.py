...
from env.house2 import House2HPEnv
...
# the two variables of the heat pump. The reward depends on electricity price. 
# Minimum control is turned on for training and testing. This control is a
# mixture between rule based control and reinforcement learning.
...
OBSERVATION_VARS = [
    ...
    ModelVariable(name="Setpoint_Act_HP_3WV", info="Actual setpoint of 3-way-valve", bounds=[0, 1]),
...
TRAIN_SPECIFIC_PARAMETER_VARS = [
    ...
    ModelVariable(name="MinimumControlEMS", value=True, unit="bool", info="Inputs can't be overwritten, if the EMS fails to keep the temperatures above the boundries of the standard control."),
]
